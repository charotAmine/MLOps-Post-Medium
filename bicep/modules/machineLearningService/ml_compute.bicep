...
resource amlWorkspace 'Microsoft.MachineLearningServices/workspaces@2022-10-01' existing = {
  name: workspaceName
}



resource workspaceName_compute 'Microsoft.MachineLearningServices/workspaces/computes@2021-07-01' = {
  name: computeName
  parent: amlWorkspace
  location: location
  properties: {
